    ...
    return (
        <div className='home-root'>
            ...
            <section className="faq-hero">
                <span className="faq-label">Podrška</span>
                <h1 className="faq-heading">Često postavljana pitanja</h1>
                ...
                <Row className="justify-content-center">
                    <Col lg={8} md={10}>
                        {faqSections.map((section, sectionIndex) => (
                            <div key={sectionIndex} className="faq-group">
                                <h2 className="faq-group-title">{section.title}</h2>
                                <Accordion>
                                    {section.items.map((item, index) => {
                                        const key = eventKeyCounter++;
                                        return (
